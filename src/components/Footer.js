                ...
                <div className="row social-bar">
                    <div className="social container">
                        <div className="row d-flex align-items-center">
                            <div className="col-md-6 col-lg-5 mb-md-0"></div>
                            <div className="col-md-6 col-lg-7 text-right">
                                <a className="m-2 fa-lg fb-ic ml-0" href="https://www.facebook.com/CashConvertersNZ" rel="noopener noreferrer" target="_blank" title="Facebook">
                                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook-square" className="svg-inline--fa fa-facebook-square fa-w-14 " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" color="white">
                    ...
                    <div className="col-lg-12">
                        <div className="footer-copyright d-flex align-items-center justify-content-center">
                            <div className="copyright-text">
                                <p>© 2022 Copyright: Cash Converters Digital NZ LP</p>
                            </div>
                        </div>
                    </div>
                </div>
